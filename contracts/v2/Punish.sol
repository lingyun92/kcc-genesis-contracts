...
contract Punish is Params, IPunish {
    uint256 public constant punishThreshold = 48;
    uint256 public constant removeThreshold = 96;
    uint256 public constant decreaseNum = 3;
    ...
    onlyBlockEpoch(_epoch)
    {
        ...
        for (uint256 i = 0; i < punishValidators.length; i++) {
            if (
                punishRecords[punishValidators[i]].missedBlocksCounter > decreaseNum) {
